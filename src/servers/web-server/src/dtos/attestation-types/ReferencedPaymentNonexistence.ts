...
export namespace ReferencedPaymentNonexistence {
  ...
  export class RequestBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The start block of the search range.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The blockNumber to be included in the search range.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The timestamp to be included in the search range.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `address hash of the address to which the payment had to be done.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The requested amount that had to be payed.` })
    amount!: string;
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `The requested standard payment reference.` })
  ...
  export class ResponseBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Timestamp of the minimalBlock.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Height of the firstOverflowBlock.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Timestamp of the firstOverflowBlock.` })
