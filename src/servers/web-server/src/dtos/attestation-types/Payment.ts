...
export namespace Payment {
  ...
  export class Request {
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Data source id as defined [here](/attestation-objectsenums.md).` })
    sourceId!: string;
  ...
  export class RequestBody {
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Id of the payment transaction.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Index of the transaction input. Always 0 for the non-utxo chains.` })
    inUtxo!: string;
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Index of the transaction output. Always 0 for the non-utxo chains.` })
    utxo!: string;
  }
  ...
  export class ResponseBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The timestamps of the block in which the transaction is included.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard address hash of the source address.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard address hash of the intended source address. Relevant if the transaction was unsuccessful.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard address hash of the receiving address.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard address hash of the intended receiving address. Relevant if the transaction was unsuccessful.` })
    intendedReceivingAddressHash!: string;

    /**
     * Amount spent by the source address.
     */
    @Validate(IsSignedIntLike)
    @ApiProperty({ description: `Amount spent by the source address.` })
    spentAmount!: string;
     ...
     */
    @Validate(IsSignedIntLike)
    @ApiProperty({ description: `Amount to be spent by the source address. Relevant if the transaction status is not success.` })
     ...
     */
    @Validate(IsSignedIntLike)
    @ApiProperty({ description: `Amount received by the receiving address.` })
     ...
     */
    @Validate(IsSignedIntLike)
    @ApiProperty({ description: `Amount intended to be received by the receiving address. Relevant if the transaction was unsuccessful.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Identifier of the transaction as defined [here](/address-objects/paymentReference.md).` })
     ...
     */
    @IsBoolean()
    @ApiProperty({ description: `Indicator whether only one source and one receiver are involved in the transaction.` })
    oneToOne!: boolean;
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Status of the transaction as described [here](/address-objects/tx-status.md):` })
    status!: string;
  }
}
