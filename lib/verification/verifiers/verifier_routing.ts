...
export async function _verifyAttestation(
  ...
  switch (attestationType) {
    case AttestationType.Payment:
      switch (sourceId) {
        case SourceId.XRP:
          return verifyPaymentXRP(client as MCC.XRP, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.BTC:
          return verifyPaymentBTC(client as MCC.BTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.LTC:
          return verifyPaymentLTC(client as MCC.LTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.DOGE:
          return verifyPaymentDOGE(client as MCC.DOGE, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.ALGO:
          return verifyPaymentALGO(client as MCC.ALGO, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        default:
    ...
    case AttestationType.BalanceDecreasingTransaction:
      switch (sourceId) {
        case SourceId.XRP:
          return verifyBalanceDecreasingTransactionXRP(client as MCC.XRP, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.BTC:
          return verifyBalanceDecreasingTransactionBTC(client as MCC.BTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.LTC:
          return verifyBalanceDecreasingTransactionLTC(client as MCC.LTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.DOGE:
          return verifyBalanceDecreasingTransactionDOGE(client as MCC.DOGE, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.ALGO:
          return verifyBalanceDecreasingTransactionALGO(client as MCC.ALGO, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        default:
          throw new WrongSourceIdError("Wrong source id");
      }
    case AttestationType.ConfirmedBlockHeightExists:
      switch (sourceId) {
        case SourceId.XRP:
          return verifyConfirmedBlockHeightExistsXRP(client as MCC.XRP, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.BTC:
          return verifyConfirmedBlockHeightExistsBTC(client as MCC.BTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.LTC:
          return verifyConfirmedBlockHeightExistsLTC(client as MCC.LTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.DOGE:
          return verifyConfirmedBlockHeightExistsDOGE(client as MCC.DOGE, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.ALGO:
          return verifyConfirmedBlockHeightExistsALGO(client as MCC.ALGO, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        default:
          throw new WrongSourceIdError("Wrong source id");
      }
    case AttestationType.ReferencedPaymentNonexistence:
      switch (sourceId) {
        case SourceId.XRP:
          return verifyReferencedPaymentNonexistenceXRP(client as MCC.XRP, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.BTC:
          return verifyReferencedPaymentNonexistenceBTC(client as MCC.BTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.LTC:
          return verifyReferencedPaymentNonexistenceLTC(client as MCC.LTC, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.DOGE:
          return verifyReferencedPaymentNonexistenceDOGE(client as MCC.DOGE, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        case SourceId.ALGO:
          return verifyReferencedPaymentNonexistenceALGO(client as MCC.ALGO, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        default:
          throw new WrongSourceIdError("Wrong source id");
      }
    case AttestationType.TrustlineIssuance:
      switch (sourceId) {
        case SourceId.XRP:
          return verifyTrustlineIssuanceXRP(client as MCC.XRP, attestationRequest, roundId, numberOfConfirmations, indexer, recheck);
        default:
          throw new WrongSourceIdError("Wrong source id");
      }
    default:
