...
@Controller("XRP/ReferencedPaymentNonexistence")
@UseGuards(AuthGuard("api-key"))
@ApiSecurity("X-API-KEY")
export class XRPReferencedPaymentNonexistenceVerifierController {
    constructor(private readonly verifierService: XRPReferencedPaymentNonexistenceVerifierService) {}
