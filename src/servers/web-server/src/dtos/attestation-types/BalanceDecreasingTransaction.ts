...
export namespace BalanceDecreasingTransaction {
  ...
  export class RequestBody {
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `The transaction identification.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `The indicator of the address whose balance has been decreased.` })
  ...
  export class ResponseBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `The number of the block in which the transaction is included.` })
    blockNumber!: string;
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard address hash of the address indicated by the 'sourceAddressIndicator'.` })
     ...
     */
    @IsHexadecimal()
    @ApiProperty({ description: `Standard payment reference of the transaction.` })
