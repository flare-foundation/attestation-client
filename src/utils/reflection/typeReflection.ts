...
export function isEqualType(A: any, B: any, parent = ""): boolean {
  const testAB = isEqualTypeUni(parent, A, B, "missing property", "property using default value", true);
  const testBA = isEqualTypeUni(parent, B, A, "unknown property", "", false);
