...
@Controller("XRP/BalanceDecreasingTransaction")
@UseGuards(AuthGuard("api-key"))
@ApiSecurity("X-API-KEY")
export class XRPBalanceDecreasingTransactionVerifierController {
    constructor(private readonly verifierService: XRPBalanceDecreasingTransactionVerifierService) {}
