declare module "@openzeppelin/test-helpers" {
   ...
   */
  export function expectEvent<T extends Truffle.AnyEvent>(
    response: Truffle.TransactionResponse<T>,
    eventName: T["name"],
    eventArgs?: Partial<StringForBN<T["args"]>>
  ): void;
  ...
  export namespace expectEvent {
     ...
     * @param eventArgs expected event args (not necessarily all)
     */
    function inTransaction<T extends Truffle.AnyEvent = Truffle.AnyEvent>(
      receiptTx: string,
     ...
     * @param eventArgs expected event args (not necessarily all)
     */
    function inConstruction<T extends Truffle.AnyEvent = Truffle.AnyEvent>(
      emitter: Truffle.ContractInstance,
      eventName: T["name"],
      eventArgs?: Partial<StringForBN<T["args"]>>
    ): Promise<void>;
