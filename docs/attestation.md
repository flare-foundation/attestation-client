...
- **response formatn** - defines, which data (and data types) are obtained from the sources and how are hashed if attestation provider is able to verify the attestation request successfully.
