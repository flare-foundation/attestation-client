...
@Controller("BTC/BalanceDecreasingTransaction")
@UseGuards(AuthGuard("api-key"))
@ApiSecurity("X-API-KEY")
export class BTCBalanceDecreasingTransactionVerifierController {
    constructor(private readonly verifierService: BTCBalanceDecreasingTransactionVerifierService) {}
