...
export namespace ConfirmedBlockHeightExists {
  ...
  export class RequestBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Number of the block the request wants a confirmation of.` })
    blockNumber!: string;
  ...
  export class ResponseBody {
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Timestamp of the block with 'blockNumber'.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Block number of the latest block that has a timestamp strictly smaller than 'blockTimestamp' - 'queryWindow'.` })
     ...
     */
    @Validate(IsUnsignedIntLike)
    @ApiProperty({ description: `Timestamp of the block at height 'lowestQueryWindowBlockNumber'.` })
